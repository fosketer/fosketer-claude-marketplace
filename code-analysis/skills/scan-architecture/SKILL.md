...
3. ID = ARCH-{file_hash6}-{line_bucket}
...
2. ID = ARCH-000000-0000-{title_hash4}
...
Example: if `ARCH-8f3a21-0370` and `ARCH-8f3a21-0370-2` are carried forward, a new collision gets `ARCH-8f3a21-0370-3`.
