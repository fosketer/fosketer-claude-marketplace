...
3. ID = TST-{file_hash6}-{title_hash4}
...
Example: if `TST-8f3a21-a1b2` and `TST-8f3a21-a1b2-2` are carried forward, a new collision gets `TST-8f3a21-a1b2-3`.
