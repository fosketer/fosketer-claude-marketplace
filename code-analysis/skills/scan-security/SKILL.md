...
3. ID = SEC-{file_hash6}-{line_bucket}
...
2. ID = SEC-000000-0000-{title_hash4}
...
Example: if `SEC-8f3a21-0370` and `SEC-8f3a21-0370-2` are carried forward, a new collision gets `SEC-8f3a21-0370-3`.
