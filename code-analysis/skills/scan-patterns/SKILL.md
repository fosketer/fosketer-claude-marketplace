...
3. ID = PAT-{file_hash6}-{line_bucket}
...
2. ID = PAT-000000-0000-{title_hash4}
...
Example: if `PAT-8f3a21-0370` and `PAT-8f3a21-0370-2` are carried forward, a new collision gets `PAT-8f3a21-0370-3`.
