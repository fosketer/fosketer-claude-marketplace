...
3. ID = DEBT-{file_hash6}-{line_bucket}
...
2. ID = DEBT-000000-0000-{title_hash4}
...
Example: if `DEBT-8f3a21-0370` and `DEBT-8f3a21-0370-2` are carried forward, a new collision gets `DEBT-8f3a21-0370-3`.
...
```
SCAN_REPORTS_DIR/*-tech-debt.json
```
