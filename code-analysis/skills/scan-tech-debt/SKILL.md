...
3. ID = DEBT-{file_hash6}-{title_hash4}
...
Example: if `DEBT-8f3a21-a1b2` and `DEBT-8f3a21-a1b2-2` are carried forward, a new collision gets `DEBT-8f3a21-a1b2-3`.
