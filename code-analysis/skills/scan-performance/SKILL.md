...
3. ID = PERF-{file_hash6}-{line_bucket}
...
2. ID = PERF-000000-0000-{title_hash4}
...
Example: if `PERF-8f3a21-0370` and `PERF-8f3a21-0370-2` are carried forward, a new collision gets `PERF-8f3a21-0370-3`.
