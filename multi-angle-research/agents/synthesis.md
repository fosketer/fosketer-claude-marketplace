...
name: synthesis
description: |
  Use this agent when multiple angle-specific brainstorms are complete and need to be merged into a coherent cross-angle synthesis with ranked directions.
